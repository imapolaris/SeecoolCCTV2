!function (e, t) {
    var a = function (t, a) {
        function i(e) {
            ...
            var t = y.offset(), a = t[c], i = v ? e.pageY : e.pageX;
        ...
        var o = this, l = e.extend({}, e.fn.ace_scroll.defaults, a);
        ...
        this.create = function (t) {
            if (!b) {
                if (t && (l = e.extend({}, e.fn.ace_scroll.defaults, t)), this.size = parseInt(this.$element.attr("data-size")) || l.size || 200, v = !l.horizontal, c = v ? "top" : "left", d = v ? "height" : "width", u = v ? "maxHeight" : "maxWidth", h = v ? "clientHeight" : "clientWidth", f = v ? "scrollTop" : "scrollLeft", p = v ? "scrollHeight" : "scrollWidth", this.$element.addClass("ace-scroll " + ((v ? "" : " scroll-hz") + (l.styleClass ? " " + l.styleClass : ""))), "static" == this.$element.css("position") ? (S = this.element.style.position, this.element.style.position = "relative") : S = !1, this.$element.wrapInner('<div class="scroll-content" />'), this.$element.prepend('<div class="scroll-track"><div class="scroll-bar"></div></div>'), _ = this.$element.find(".scroll-content").eq(0), v || _.wrapInner("<div />"), w = _.get(0), y = this.$element.find(".scroll-track").eq(0), x = y.find(".scroll-bar").eq(0), C = y.get(0), k = x.get(0), $ = k.style, y.hide(), y.on("mousedown", i), x.on("mousedown", n), _.on("scroll", function () {
                    ...
                    var a = l.mouseWheelLock, s = l.lockAnyway;
                    this.$element.on("mousewheel.ace_scroll DOMMouseScroll.ace_scroll", function (t) {
                        if (!g) {
                            ...
                            var i = t.originalEvent.detail < 0 || t.originalEvent.wheelDelta > 0 ? 1 : -1, n = !1, r = w[h], l = w[f];
    ...
    e.fn.ace_scroll = function (i, n) {
        var s, r = this.each(function () {
            var t = e(this), r = t.data("ace_scroll"), o = "object" == typeof i && i;
    ...
    var a = function (t, a) {
        var i = e.extend({}, e.fn.ace_colorpicker.defaults, a), n = e(t), s = "", r = "", o = null, l = [];
    ...
    e.fn.ace_colorpicker = function (i, n) {
        var s, r = this.each(function () {
            var t = e(this), r = t.data("ace_colorpicker"), o = "object" == typeof i && i;
    ...
    var a = "multiple" in document.createElement("INPUT"), i = "FileList" in window, n = "FileReader" in window, s = "File" in window, r = function (t, a) {
        var i = this;
        ...
        var n = this.$element.closest("label").css({display: "block"}), s = 0 == n.length ? "label" : "span";
    ...
    r.error = {
        ...
        if (a && 0 != a.length) {
            ...
            for (var i = 0; i < a.length; i++) {
                var s = "string" == typeof a[i] ? a[i] : e.trim(a[i].name), r = s.lastIndexOf("\\") + 1;
                ...
                if (/\.(jpe?g|png|gif|svg|bmp|tiff?)$/i.test(s) ? (o = "fa fa-picture-o file-image", l = "image") : /\.(mpe?g|flv|mov|avi|swf|mp4|mkv|webm|wmv|3gp)$/i.test(s) ? (o = "fa fa-film file-video", l = "video") : /\.(mp3|ogg|wav|wma|amr|aac)$/i.test(s) && (o = "fa fa-music file-audio", l = "audio"), this.well_style) {
                    ...
                    var d = e.trim(a[i].type), u = n && this.settings.thumbnail && (d.length > 0 && d.match("image") || 0 == d.length && "image" == l);
                    if (u) {
                        var h = this;
        ...
        if (t === !1)this.$container.find(".ace-file-overlay").remove(), this.element.removeAttribute("readonly"); else {
            var a = "string" == typeof t ? t : '<i class="overlay-content fa fa-spin fa-spinner orange2 fa-2x"></i>', i = this.$container.find(".ace-file-overlay");
    ...
    var o = function () {
        ...
        t.off("dragenter").on("dragenter", function (e) {
            ...
            if (t.preventDefault(), t.stopPropagation(), !e.disabled) {
                var a = t.originalEvent.dataTransfer, i = a.files;
        ...
        var a = this, i = a.$label.find(".ace-file-name:last"), n = new e.Deferred, s = new FileReader;
        return s.onload = function (s) {
            ...
            e(o).one("load", function () {
                ...
                var l = d(o, s, t.type);
                if (null == l)return e(this).remove(), void n.reject({code: r.error.THUMBNAIL_FAILED});
                var c = l.w, u = l.h;
                "small" == a.settings.thumbnail && (c = u = s), e(o).css({
                    "background-image": "url(" + l.src + ")",
                    width: c,
                    height: u
                }).data("thumb", l.src).attr({src: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg=="}).show(), n.resolve()
            }).one("error", function () {
                i.find("img").remove(), n.reject({code: r.error.IMAGE_LOAD_FAILED})
        ...
        var i = h(this.settings.allowExt), n = h(this.settings.denyExt), r = f(this.settings.allowMime), o = f(this.settings.denyMime), l = this.settings.maxSize || !1;
        if (!(i || n || r || o || l))return !0;
        for (var c = [], d = {}, u = 0; u < t.length; u++) {
            var p = t[u], v = s ? p.name : p;
            if (!i || i.test(v))if (n && n.test(v))"ext" in d || (d.ext = []), d.ext.push(v); else {
                var g;
                if (s) {
    ...
    e.fn.ace_file_input = function (a, i) {
        var n, s = this.each(function () {
            var t = e(this), s = t.data("ace_file_input"), o = "object" == typeof a && a;
    ...
    t.prototype = {
        constructor: t, select: function () {
            ...
            var t = this.$menu.find(".active").removeClass("active"), a = t.next();
    ...
    e.fn.bs_typeahead = function (a) {
        return this.each(function () {
            var i = e(this), n = i.data("bs_typeahead"), s = "object" == typeof a && a;
    ...
    e.fn.ace_wysiwyg = function (t) {
        var a = e.extend({
            speech_button: !0,
            wysiwyg: {}
        }, t), i = ["#ac725e", "#d06b64", "#f83a22", "#fa573c", "#ff7537", "#ffad46", "#42d692", "#16a765", "#7bd148", "#b3dc6c", "#fbe983", "#fad165", "#92e1c0", "#9fe1e7", "#9fc6e7", "#4986e7", "#9a9cff", "#b99aff", "#c2c2c2", "#cabdbf", "#cca6ac", "#f691b2", "#cd74e6", "#a47ae2", "#444444"], n = {
            font: {
            ...
            foreColor: {values: i, title: "Change Color"},
            backColor: {values: i, title: "Change Background Color"},
        ...
        return this.each(function () {
            ...
            for (var i in s)if (s.hasOwnProperty(i)) {
                ...
                if ("string" == typeof r && r in n)r = n[r], r.name = s[i]; else {
            ...
            var p = e.extend({}, {activeToolbarClass: "active", toolbarSelector: t}, a.wysiwyg || {});
            e(this).wysiwyg(p)
        }), this
    }
}(window.jQuery), function (e, t) {
    function a(t, a) {
        var i = a.max;
        i = ("" + i).length;
        var n = parseInt(Math.max(20 * i + 40, 90)), s = e(t);
        s.addClass("spinner-input form-control").wrap('<div class="ace-spinner">');
        var r = s.closest(".ace-spinner").spinner(a).wrapInner("<div class='input-group'></div>"), o = r.data("spinner");
    ...
    e.fn.ace_spinner = function (i, n) {
        var s, r = this.each(function () {
            var t = e(this), r = t.data("ace_spinner"), o = "object" == typeof i && i;
    ...
    e.fn.ace_wizard = function (t) {
        return this.each(function () {
            var a = e(this);
            a.wizard();
            var i = a.siblings(".wizard-actions").eq(0), n = a.data("wizard");
